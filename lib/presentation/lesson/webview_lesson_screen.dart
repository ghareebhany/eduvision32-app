                  ...
                  if (_loading)
                    const Center(
                      child: CircularProgressIndicator(
                        valueColor: AlwaysStoppedAnimation<Color>(Color(0xFFF87625)),
                      ),
                    ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextButton.icon(
                            ...
                            icon: const Icon(Icons.refresh, color: Color(0xFFF87625)),
                            label: const Text('إعادة المحاولة',
                                style: TextStyle(color: Color(0xFFF87625))),
                          ),
                        ],
                      ),
                    ),
        ...
        children: [
          TextButton(
            ...
            style: TextButton.styleFrom(
              foregroundColor: hasPrev ? const Color(0xFFF87625) : Colors.grey,
            ),
          ...
          TextButton(
            ...
            style: TextButton.styleFrom(
              foregroundColor: hasNext ? const Color(0xFFF87625) : Colors.grey,
            ),
        ...
        itemBuilder: (_, i) {
          ...
          return ListTile(
            title: Text(
              l.title,
              style: TextStyle(
                color:      isCurrent ? const Color(0xFFF87625) : Colors.white,
                fontWeight: isCurrent ? FontWeight.bold : FontWeight.normal,
              ),
            ),
            trailing: isCurrent
                ? const Icon(Icons.play_circle, color: Color(0xFFF87625), size: 20)
                : null,
            onTap: () {
