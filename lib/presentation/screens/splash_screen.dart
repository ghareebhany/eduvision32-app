...
class _SplashScreenState extends ConsumerState<SplashScreen>
  ...
  void initState() {
    super.initState();
    // Fix: نداء إمبراتيفي كان يفرض أيقونات فاتحة مرة واحدة عند فتح
    // التطبيق ويضارب مع الضبط التفاعلي في main.dart — استُبدل بـ
    // AnnotatedRegion في build() (شاشة السبلاش غامقة دائماً بتصميمها
    // بغضّ النظر عن ثيم التطبيق، فده ثابت وصحيح هنا فقط).
